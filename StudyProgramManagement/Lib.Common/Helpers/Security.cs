...
namespace Lib.Common.Helpers
{
    public static class Security
    {
        ...
        //}
        //public static void UserSignIn(UserProfile accountInfo, HttpContext curentHttpContext)
        //{
        //    var token = SetAuthCookie(curentHttpContext, JsonConvert.SerializeObject(accountInfo), "future_cookies", "future_cookies_keyauthen", DateTime.Now.AddDays(15));
        //}
        //public static void Logout(HttpContext httpContext)
        //{
        //    var cookie = new HttpCookie("future_cookies");
        //    DateTime nowDateTime = DateTime.Now;
        //    cookie.Expires = nowDateTime.AddDays(-1);
        //    httpContext.Response.Cookies.Add(cookie);
        //    httpContext.Request.Cookies.Remove("future_cookies");
